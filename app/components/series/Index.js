...
export class Index extends Component {
    ...
    handleSubmit = (e) => {
        ...
        axios.get(`https://api.themoviedb.org/3/search/tv?api_key=9abb06545efd48e40e6c416930822c98&language=en-US&query=${this.state.searchQuery}`)
        .then(res => {
            this.setState({
    ...
    componentDidMount(){
        ...
        const api_url = `https://api.themoviedb.org/3/tv/airing_today?api_key=${key}&language=en-US&timezone=Africa/Lagos`;
